...
* [**`sentinelhub-py`**](https://github.com/sentinel-hub/sentinelhub-py) ⭐ 911 | 🐛 23 | 🌐 Python | 📅 2026-09-16
...
* [**`eodag`**](https://github.com/CS-SI/eodag) ⭐ 435 | 🐛 176 | 🌐 Python | 📅 2026-09-25
...
* [**`sat-api`**](https://github.com/sat-utils/sat-api) ⭐ 178 | 🐛 24 | 🌐 JavaScript | 📅 2020-07-28
...
* [**`Sentinel2ProductIngestor`**](https://github.com/sinergise/Sentinel2ProductIngestor) ⭐ 32 | 🐛 0 | 🌐 Java | 📅 2017-04-21
...
* [**`awsdownload`**](https://github.com/kraftek/awsdownload) ⭐ 20 | 🐛 2 | 🌐 Java | 📅 2018-07-16
  * downloader for Sentinel-2 products from Amazon or SciHub
* [**`aws-sat-api`**](https://github.com/RemotePixel/aws-sat-api) ⚠️ Archived
  * Simple Serverless API for satellite data hosted on AWS Public Dataset
* [**`sentinel2-search-api`**](https://github.com/beaorn/sentinel2-search-api) ⭐ 7 | 🐛 0 | 🌐 Ruby | 📅 2018-04-07
...
* [**`sentinel2_aws`**](https://github.com/beaorn/sentinel2_aws) ⭐ 6 | 🐛 0 | 🌐 Ruby | 📅 2018-04-07
...
* [**jeobrowser "Rocket"**](https://mapshup.com/projects/rocket)
  * based on [resto](https://github.com/jjrom/resto) ⭐ 61 | 🐛 6 | 🌐 PHP | 📅 2026-09-21 search engine and used as frontend for [PEPS](https://peps.cnes.fr/rocket/)
...
* ~~[**RemotePixel "Viewer"**](https://viewer.remotepixel.ca)~~ **(no longer active)**
  * uses [**`sentinel-tiler`**](https://github.com/mapbox/sentinel-tiler) ⚠️ Archived (tiles server based on AWS Lambda)
  * [open source](https://github.com/RemotePixel/viewer.remotepixel.ca) ⭐ 28 | 🐛 1 | 🌐 JavaScript | 📅 2019-07-15 viewer for Landsat-8, Sentinel-2 and CBERS-4 data hosted by AWS

* ~~[**RemotePixel "Satellite Search"**](https://remotepixel.ca/projects/satellitesearch.html)~~ **(no longer active)**
  * uses [**`remotepixel-api`**](https://github.com/RemotePixel/remotepixel-api) ⚠️ Archived (based on AWS Lambda)
  * [open source](https://github.com/RemotePixel/satellitesearch) ⚠️ Archived Browser for Landsat-8 and Sentinel-2 data hosted by AWS
...
* [**`EOReader`**](https://github.com/sertit/eoreader) ⭐ 349 | 🐛 63 | 🌐 Python | 📅 2026-09-25
...
* [**`ACOLITE`**](https://github.com/acolite/acolite) ⭐ 251 | 🐛 47 | 🌐 Python | 📅 2026-09-24
  * atmospheric correction algorithms for aquatic applications of Landsat and Sentinel-2
* [**`FORCE Processing Framework`**](https://github.com/davidfrantz/force) ⭐ 201 | 🐛 17 | 🌐 C | 📅 2026-09-25
...
* [**`sen2r`**](https://github.com/ranghetti/sen2r) ⭐ 166 | 🐛 1 | 🌐 R | 📅 2024-03-27
...
* [**`C2RCC`**](https://github.com/bcdev/s3tbx-c2rcc) ⚠️ Archived
...
* [**`SNAP` (Sentinel Application Plattform)**](http://step.esa.int/main/toolboxes/snap/)
  * also available as [docker](https://github.com/edwardpmorris/docker-snap) ⭐ 28 | 🐛 2 | 🌐 Python | 📅 2016-05-09
...
* [**`MAJA` (MACCS ATCOR Joint Algorithm)** ](https://logiciels.cnes.fr/en/content/maja)
  * used for [Theia](https://theia.cnes.fr/atdistrib/rocket/#/search?collection=SENTINEL2) and [`Sen2-Agri`](https://github.com/Sen2Agri/Sen2Agri-System) ⭐ 133 | 🐛 21 | 🌐 HTML | 📅 2020-11-23
